...
public class DefaultPropertyMapper implements PropertyMapper {
    ...
    private Set<? extends MappedProperty<?>> mapTableOrUdt(Class<?> entityClass, Collection<? extends Class<? extends Annotation>> allowed) {
        ...
        for (Map.Entry<String, Object[]> entry : fieldsGettersAndSetters.entrySet()) {
            ...
            String mappedName = inferMappedName(propertyName, annotations);
            MappedProperty<?> property = createMappedProperty(propertyName, field, getter, setter, annotations, mappedName);
    ...
    /**
     * Infers the mapped object name.
     *
     * @param propertyName
     * @param annotations
     * @return
     */
    protected String inferMappedName(String propertyName, Map<Class<? extends Annotation>, Annotation> annotations) {
     ...
     * Instances returned here will use the Java reflection API to read and write values.
     ...
     * @return
     */
    protected MappedProperty<?> createMappedProperty(String propertyName, Field field, Method getter, Method setter, Map<Class<? extends Annotation>, Annotation> annotations, String mappedName) {
        return DefaultMappedProperty.create(propertyName, mappedName, field, getter, setter, annotations);
    }
